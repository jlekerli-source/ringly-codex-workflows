...
grep -q 'jlekerli-source/ringly-codex-workflows/actions/release-consume@v3.21.0' "$workflow"
grep -q 'jlekerli-source/ringly-codex-workflows/actions/release-diff@v3.21.0' "$workflow"
grep -q 'jlekerli-source/ringly-codex-workflows/actions/release-evidence@v3.21.0' "$workflow"
...
grep -q 'jlekerli-source/ringly-codex-workflows/actions/release-evidence@v3.21.0' "$bundle_workflow"
