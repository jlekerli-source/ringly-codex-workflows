...
if "skill/plugin runtime receipt fixtures" not in priority.get("question", ""):
    raise SystemExit(f"expected next uncovered skill/plugin runtime receipt value-gauntlet question as priority: {priority!r}")
PY
