...
if "scenario-failure receipts" not in priority.get("question", ""):
    raise SystemExit(f"expected next uncovered scenario-failure receipt value-gauntlet question as priority: {priority!r}")
PY
