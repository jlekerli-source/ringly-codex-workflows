...
if "target-onboarding receipts" not in priority.get("question", ""):
    raise SystemExit(f"expected next uncovered target-onboarding receipt value-gauntlet question as priority: {priority!r}")
PY
