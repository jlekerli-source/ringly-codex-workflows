...
grep -q '"case_count": 14' "$tmp_dir/arena/results.json"
grep -q '"average_total": 5.21' "$tmp_dir/arena/results.json"
grep -q '"high_risk_finding_count": 17' "$tmp_dir/arena/results.json"
grep -q '"validation_evidence_cases": 5' "$tmp_dir/arena/results.json"
grep -q '"validation_evidence_ratio": 0.36' "$tmp_dir/arena/results.json"
grep -q '"validation_quality_average": 0.71' "$tmp_dir/arena/results.json"
grep -q '"scope_control_average": 1.14' "$tmp_dir/arena/results.json"
