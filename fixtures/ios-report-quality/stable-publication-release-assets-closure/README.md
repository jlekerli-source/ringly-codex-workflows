# stable-publication-release-assets-closure
...
- Suggested repo path: `fixtures/ios-report-quality/stable-publication-release-assets-closure`
- Promotion is explicit maintainer work; generated candidates are not auto-copied into the repo.

Copy commands:

- `mkdir -p fixtures/ios-report-quality/stable-publication-release-assets-closure`
- `cp <materialized-candidate-dir>/README.md fixtures/ios-report-quality/stable-publication-release-assets-closure/README.md`
- `cp <materialized-candidate-dir>/fixture-candidate.json fixtures/ios-report-quality/stable-publication-release-assets-closure/fixture-candidate.json`
- `cp <materialized-candidate-dir>/fixture-report.json fixtures/ios-report-quality/stable-publication-release-assets-closure/fixture-report.json`
- `cp <materialized-candidate-dir>/fixture-report.md fixtures/ios-report-quality/stable-publication-release-assets-closure/fixture-report.md`

Promotion validation:

- `./bin/shipguard ios report-quality --reports fixtures/ios-report-quality/stable-publication-release-assets-closure --out <quality-dir> --shareable`
- `./tests/ios_report_quality_test.sh`
