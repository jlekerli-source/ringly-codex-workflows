...
- Added `shipguard lean audit`, a ShipGuard-native Lean Deck influenced by Ponytail that scans for native platform, standard-library, dependency, thin-wrapper, and does-this-need-to-exist simplification opportunities while marking security, validation, data-loss, permission, payment, migration, and accessibility files as proof-required safety boundaries. The new surface ships with docs, a public fixture, report-quality support, smoke/self-audit/package proof, and Codex skill routing for Ponytail-style precise-code reviews.
