...
| Generate iOS spec workflow | `ios spec-workflow` | ShipGuard-owned constitution, feature spec, implementation plan, tasks, analysis gates, slash plan/goal, Devspace guardrails, and report-quality artifact completeness/content/question checks |
