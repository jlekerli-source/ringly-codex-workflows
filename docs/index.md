...
18. Run `./bin/codex-maintainer release-manifest --tarball dist/codex-maintainer-v3.18.0.tar.gz --out /tmp/codex-maintainer-release-proof` after packaging.
...
20. Run `./bin/codex-maintainer release-replay verify --manifest /tmp/codex-maintainer-release-proof/release-manifest.json --tarball dist/codex-maintainer-v3.18.0.tar.gz --index /tmp/codex-maintainer-release-index/release-index.json --ledger /tmp/codex-maintainer-release-proof/proof-ledger.md --out /tmp/codex-maintainer-release-replay`.
...
22. Run `./bin/codex-maintainer release-proof build --out /tmp/codex-maintainer-release-proof-bundle --release-url https://github.com/owner/repo/releases/tag/v3.18.0`.
23. Run `./bin/codex-maintainer release-consume verify --dir /tmp/codex-maintainer-v3.18.0 --out /tmp/codex-maintainer-v3.18.0/consumer-proof --version 3.18.0` after downloading published assets.
24. Use `jlekerli-source/ringly-codex-workflows/actions/release-consume@v3.18.0` when the same verification should run in GitHub Actions.
25. Run `./bin/codex-maintainer release-diff compare --left /tmp/codex-maintainer-old --right /tmp/codex-maintainer-v3.18.0 --out /tmp/codex-maintainer-release-diff`.
26. Use `jlekerli-source/ringly-codex-workflows/actions/release-diff@v3.18.0` when the same diff should run in GitHub Actions.
27. Run `./bin/codex-maintainer release-evidence site --consume /tmp/codex-maintainer-v3.18.0/consumer-proof --diff /tmp/codex-maintainer-release-diff --out /tmp/codex-maintainer-release-site`.
...
29. Use `jlekerli-source/ringly-codex-workflows/actions/release-evidence@v3.18.0` when the same evidence export should run in GitHub Actions.
30. Run `./bin/codex-maintainer self-audit --out /tmp/codex-maintainer-self-audit`.
31. Run `./bin/codex-maintainer next-goal --out /tmp/NEXT_GOAL.md`.
