...
29. Use `jlekerli-source/ShipGuard/actions/arena-compare@v3.97.0` when the same comparison should run in GitHub Actions.
...
33. Run `./bin/shipguard release-manifest --tarball dist/shipguard-v3.97.0.tar.gz --out /tmp/shipguard-release-proof` after packaging.
...
35. Run `./bin/shipguard release-replay verify --manifest /tmp/shipguard-release-proof/release-manifest.json --tarball dist/shipguard-v3.97.0.tar.gz --index /tmp/shipguard-release-index/release-index.json --ledger /tmp/shipguard-release-proof/proof-ledger.md --out /tmp/shipguard-release-replay`.
...
37. Run `./bin/shipguard release-proof build --out /tmp/shipguard-release-proof-bundle --release-url https://github.com/owner/repo/releases/tag/v3.97.0`.
38. Run `./bin/shipguard release-consume verify --dir /tmp/shipguard-v3.97.0 --out /tmp/shipguard-v3.97.0/consumer-proof --version 3.97.0` after downloading published assets.
39. Use `jlekerli-source/ShipGuard/actions/release-consume@v3.97.0` when the same verification should run in GitHub Actions.
40. Run `./bin/shipguard release-diff compare --left /tmp/shipguard-old --right /tmp/shipguard-v3.97.0 --out /tmp/shipguard-release-diff`.
41. Use `jlekerli-source/ShipGuard/actions/release-diff@v3.97.0` when the same diff should run in GitHub Actions.
42. Run `./bin/shipguard release-evidence site --consume /tmp/shipguard-v3.97.0/consumer-proof --diff /tmp/shipguard-release-diff --out /tmp/shipguard-release-site`.
43. Run `./bin/shipguard release-evidence index --site /tmp/shipguard-release-site --out /tmp/shipguard-release-history`.
44. Run `./bin/shipguard release-evidence bundle --assets /tmp/shipguard-v3.97.0 --left /tmp/shipguard-old --out /tmp/shipguard-release-evidence-bundle --version 3.97.0`.
45. Use `jlekerli-source/ShipGuard/actions/release-evidence@v3.97.0` when the same evidence export should run in GitHub Actions.
...
47. Use `jlekerli-source/ShipGuard/actions/release-evidence-verify@v3.97.0` when the evidence artifact verification should run in GitHub Actions.
...
49. Use `jlekerli-source/ShipGuard/actions/release-evidence-negative-index@v3.97.0` when the same negative fixture index should run in GitHub Actions.
50. Use `jlekerli-source/ShipGuard/actions/transcript-verify@v3.97.0` when redacted transcripts should be checked in GitHub Actions.
...
52. Use `jlekerli-source/ShipGuard/actions/transcript-corpus@v3.97.0` when transcript corpus checks should run in GitHub Actions.
