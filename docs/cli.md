...
When release notes are the first blocker, the generated `gh release edit --notes-file` command points at the draft under the report output directory; shareable reports redact that local path.
