...
./bin/shipguard release-manifest \
  --tarball dist/shipguard-v3.94.0.tar.gz \
...
./bin/shipguard release-index build \
  ...
  --manifest dist/release-proof-v3.94.0/release-manifest.json \
...
./bin/shipguard release-replay verify \
  --manifest /tmp/shipguard-release-proof/release-manifest.json \
  --tarball /tmp/shipguard-release-assets/shipguard-v3.94.0.tar.gz \
...
./bin/shipguard release-proof build \
  ...
  --release-url https://github.com/owner/repo/releases/tag/v3.94.0
```
...
./bin/shipguard release-evidence index \
  ...
  --site /tmp/shipguard-v3.94.0-site \
...
./bin/shipguard release-evidence bundle \
  ...
  --version 3.94.0 \
  --title "ShipGuard v3.94.0 Evidence"
```
