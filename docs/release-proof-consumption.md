...
For CI, use `jlekerli-source/ringly-codex-workflows/actions/release-consume@v3.15.0` to download the assets, run this verification, upload the consumer proof bundle, and fail the job when proof is invalid.

Download the release assets from GitHub:

```bash
mkdir -p /tmp/codex-maintainer-v3.15.0
...
- `/tmp/codex-maintainer-v3.15.0/consumer-proof/consumer-report.json`
- `/tmp/codex-maintainer-v3.15.0/consumer-proof/consumer-report.md`
- `/tmp/codex-maintainer-v3.15.0/consumer-proof/asset-digests.json`
- `/tmp/codex-maintainer-v3.15.0/consumer-proof/asset-digests.md`
- `/tmp/codex-maintainer-v3.15.0/consumer-proof/replay/replay-report.json`
- `/tmp/codex-maintainer-v3.15.0/consumer-proof/replay/replay-report.md`
- `/tmp/codex-maintainer-v3.15.0/consumer-proof/attestation/attestation.json`
- `/tmp/codex-maintainer-v3.15.0/consumer-proof/attestation/attestation.md`
- `/tmp/codex-maintainer-v3.15.0/consumer-proof/attestation/attestation-badge.json`

Accept the release only when:

- `replay-report.json` has `"status": "pass"`.
- `attestation.json` has `"status" : "pass"` and `"blocked" : 0`.
- `attestation-badge.json` says `pass v3.15.0`.
