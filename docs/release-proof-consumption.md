...
For CI, use `jlekerli-source/ShipGuard/actions/release-consume@v3.97.0` to download the assets, run this verification, upload the consumer proof bundle, and fail the job when proof is invalid. Use `jlekerli-source/ShipGuard/actions/release-evidence@v3.97.0` afterward when you want a static HTML evidence artifact.

Download the release assets from GitHub:

```bash
mkdir -p /tmp/shipguard-v3.97.0
...
- `/tmp/shipguard-v3.97.0/consumer-proof/consumer-report.json`
- `/tmp/shipguard-v3.97.0/consumer-proof/consumer-report.md`
- `/tmp/shipguard-v3.97.0/consumer-proof/asset-digests.json`
- `/tmp/shipguard-v3.97.0/consumer-proof/asset-digests.md`
- `/tmp/shipguard-v3.97.0/consumer-proof/replay/replay-report.json`
- `/tmp/shipguard-v3.97.0/consumer-proof/replay/replay-report.md`
- `/tmp/shipguard-v3.97.0/consumer-proof/attestation/attestation.json`
- `/tmp/shipguard-v3.97.0/consumer-proof/attestation/attestation.md`
- `/tmp/shipguard-v3.97.0/consumer-proof/attestation/attestation-badge.json`
...
./bin/shipguard release-evidence site \
  ...
  --out /tmp/shipguard-v3.97.0/evidence-site
```
...
./bin/shipguard release-evidence bundle \
  ...
  --out /tmp/shipguard-v3.97.0-evidence-bundle \
  --version 3.97.0
```
...
- `attestation-badge.json` says `pass v3.97.0`.
