...
For CI, use `jlekerli-source/ringly-codex-workflows/actions/release-consume@v3.18.0` to download the assets, run this verification, upload the consumer proof bundle, and fail the job when proof is invalid. Use `jlekerli-source/ringly-codex-workflows/actions/release-evidence@v3.18.0` afterward when you want a static HTML evidence artifact.

Download the release assets from GitHub:

```bash
mkdir -p /tmp/codex-maintainer-v3.18.0
gh release download v3.18.0 \
  --repo jlekerli-source/ringly-codex-workflows \
  --pattern 'codex-maintainer-v3.18.0.tar.gz' \
  ...
  --dir /tmp/codex-maintainer-v3.18.0
```
...
./bin/codex-maintainer release-consume verify \
  --dir /tmp/codex-maintainer-v3.18.0 \
  --out /tmp/codex-maintainer-v3.18.0/consumer-proof \
  --version 3.18.0
```
...
```bash
shasum -a 256 /tmp/codex-maintainer-v3.18.0/codex-maintainer-v3.18.0.tar.gz
```
...
./bin/codex-maintainer release-replay verify \
  --manifest /tmp/codex-maintainer-v3.18.0/release-manifest.json \
  --tarball /tmp/codex-maintainer-v3.18.0/codex-maintainer-v3.18.0.tar.gz \
  --index /tmp/codex-maintainer-v3.18.0/release-index.json \
  --ledger /tmp/codex-maintainer-v3.18.0/proof-ledger.md \
  --out /tmp/codex-maintainer-v3.18.0/consumer-replay
```
...
./bin/codex-maintainer release-attest build \
  --manifest /tmp/codex-maintainer-v3.18.0/release-manifest.json \
  --replay /tmp/codex-maintainer-v3.18.0/consumer-replay/replay-report.json \
  --out /tmp/codex-maintainer-v3.18.0/consumer-attestation
```

Review these files:

- `/tmp/codex-maintainer-v3.18.0/consumer-proof/consumer-report.json`
- `/tmp/codex-maintainer-v3.18.0/consumer-proof/consumer-report.md`
- `/tmp/codex-maintainer-v3.18.0/consumer-proof/asset-digests.json`
- `/tmp/codex-maintainer-v3.18.0/consumer-proof/asset-digests.md`
- `/tmp/codex-maintainer-v3.18.0/consumer-proof/replay/replay-report.json`
- `/tmp/codex-maintainer-v3.18.0/consumer-proof/replay/replay-report.md`
- `/tmp/codex-maintainer-v3.18.0/consumer-proof/attestation/attestation.json`
- `/tmp/codex-maintainer-v3.18.0/consumer-proof/attestation/attestation.md`
- `/tmp/codex-maintainer-v3.18.0/consumer-proof/attestation/attestation-badge.json`
...
./bin/codex-maintainer release-evidence site \
  ...
  --out /tmp/codex-maintainer-v3.18.0/evidence-site
```
...
- `attestation-badge.json` says `pass v3.18.0`.
