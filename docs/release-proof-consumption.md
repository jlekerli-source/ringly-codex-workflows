...
- `/tmp/shipguard-v3.113.0/consumer-proof/consumer-report.json`
- `/tmp/shipguard-v3.113.0/consumer-proof/consumer-report.md`
- `/tmp/shipguard-v3.113.0/consumer-proof/asset-digests.json`
- `/tmp/shipguard-v3.113.0/consumer-proof/asset-digests.md`
- `/tmp/shipguard-v3.113.0/consumer-proof/replay/replay-report.json`
- `/tmp/shipguard-v3.113.0/consumer-proof/replay/replay-report.md`
- `/tmp/shipguard-v3.113.0/consumer-proof/attestation/attestation.json`
- `/tmp/shipguard-v3.113.0/consumer-proof/attestation/attestation.md`
- `/tmp/shipguard-v3.113.0/consumer-proof/attestation/attestation-badge.json`
...
./bin/shipguard release-evidence site \
  ...
  --out /tmp/shipguard-v3.113.0/evidence-site
```
...
- `attestation-badge.json` says `pass v3.113.0`.
