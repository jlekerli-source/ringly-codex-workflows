...
For GitHub Actions, use `jlekerli-source/ringly-codex-workflows/actions/release-evidence@v3.21.0` after `actions/release-consume` and optional `actions/release-diff`. See `release-evidence-action.md`.
