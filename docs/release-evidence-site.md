...
For GitHub Actions, use `jlekerli-source/ShipGuard/actions/release-evidence@v3.94.0` after `actions/release-consume` and optional `actions/release-diff`. See `release-evidence-action.md`.
